      ...
      <div className="modal">
        ...
        <div className="modal-left">
          <div>
            ...
            {/* Heading — changes based on signin/register tab */}
        ...
        <div className="modal-right">
          ...
          {/* Error banner — shows backend error messages */}
          {error && (
            <div style={{
              background: "#fff1f1",
          ...
          {tab === "register" && (
            <>
              ...
              <div className="strength-bar">
                {[1, 2, 3, 4].map(n => (
                  <div
                    ...
                    style={{
                      background: n <= pwStr ? STRENGTH_COLORS[pwStr] : "#e8e4dc",
                    }}
                  />
                ))}
              </div>
              ...
              <button
                ...
                disabled={loading || success || !agree}
              >
                {loading
