...
import { productAPI, profileAPI, validateSession, clearAuthAndRedirect } from "@/lib/axios-proxy";
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <button onClick={handleSave} disabled={saving} className="action-btn"
                style={{
                  width: "100%",
                  padding: "14px",
                  background: saving ? "#6b8070" : "linear-gradient(135deg,#1a3a2a,#2d5a3d)",
                  color: "#fff",
                  border: "none",
                  borderRadius: 12,
                  fontSize: 16,
                  ...
                  marginTop: 8,
                  transition: "all .22s",
                  boxShadow: "0 4px 15px rgba(26,58,42,0.2)",
                  display: "flex",
                  alignItems: "center",
