...
// BUG FIX: was populating "consumerId","farmerId","items.productId"
// but the model uses "consumer","farmer","product"
export const adminGetAllOrders = async (req, res) => {
  try {
    ...
    const orders = await Order.find(filter)
      .populate("consumer", "name email")   // ✅ correct field name
      .populate("farmer",   "name email")   // ✅ correct field name
      .populate("product",  "cropName price") // ✅ correct field name
      .sort({ createdAt: -1 })
